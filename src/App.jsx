    ...
    <div>
        ...
        <div class="collapse navbar-collapse ml-5" id="navbarText">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#">Create Meetup <span class="sr-only">(current)</span></a>
            </li>
      ...
      <div class="m-3 mt-5">
        ...
        <div class="bg-light m-2 p-2">
          ...
          <div class="row">
            <div class="col-12">Hello JavaScript and React Js</div>
            <div class="col-12">Get ready for our monthly meetup PontianakJS! This will be our fifth meetup of 2023!</div>
            <div class="col-12">The meetup format will contain some short stories and technical talks.</div>
            <div class="col-12">If you have a short announcement you'd like to share with the audience, you may do so during open mic announcements.</div>
          </div>
          <p class="mt-3">Remember to bring a photo ID to get through building security.</p>
          <p class="mt-3">---</p>
